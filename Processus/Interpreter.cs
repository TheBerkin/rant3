...
namespace Processus
{
    internal partial class Interpreter
    {
        ...
        public void PushState(State state)
        {
            ...
            {
                throw new ProcessusException(_mainSource, null, "Exceeded maximum stack size of " + Engine.MaxStackSize + ".");
            }
        ...
        public Output Run()
        {
            ...
            while (_stateCount > 0)
            {
                ...
                while (!reader.End)
                {
                    ...
                    {
                        throw new ProcessusException(reader.Source, token, "Unexpected token '" + Lexer.Rules.GetSymbolForId(token.Identifier) + "'");
                    }
